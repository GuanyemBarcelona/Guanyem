...
class TC_sidebar {
    ...
    function __construct () {
        ...
        //displays languages sidebar
        add_action ( '__after_article_container'             , array( $this , 'tc_sidebar_display' ) );
        add_action ( '__before_languages_sidebar'                , array( $this , 'tc_social_in_sidebar' ) );
    }
    ...
    */
    function tc_sidebar_display() {
      ...
      // banner donation
      $banner_donation_id = 3792; // in PRO
      if (ICL_LANGUAGE_CODE == 'es') $banner_donation_id = 3794; // in PRO
