...
class TC_header_main {
	...
	function tc_head_display() {
		...
		<head>
		   ...
		   <!-- Icons font support for IE6-7  -->
            ...
            <link href='//fonts.googleapis.com/css?family=Raleway:900,700,400' rel='stylesheet' type='text/css'>
    ...
    function tc_social_in_header($resp = null) {
    	...
    	do_action('icl_language_selector'); /* sinsistema add language selector */
        wp_nav_menu( array( 'theme_location' => 'secundary' ) );/* sinsistema add menu top */
